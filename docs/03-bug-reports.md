...
|----|-------|----------|--------|
| BUG-001 | Bloc vide accepté sans validation dans Expériences et Formations | 🟠 Majeur | Ouvert |
| BUG-002 | Dates impossibles acceptées sans validation | 🟠 Majeur | Ouvert |
| BUG-003 | Barre de recherche redirige vers une page au lieu d'afficher les résultats | 🟡 Mineur | Ouvert |
| BUG-004 | Aucun sélecteur de langue accessible dans l'UI | 🟠 Majeur | Ouvert |
| BUG-005 | Headshot payant révélé seulement après l'upload de la photo | 🔴 Critique | Ouvert |
| BUG-006 | Import DOCX vide — message d'erreur générique sans indication sur la cause | 🟡 Mineur | Ouvert |
| BUG-007 | Import PDF vide — accepté sans erreur, CV vide généré silencieusement | 🟠 Majeur | Ouvert |
| BUG-008 | Aucun bouton pour quitter le tunnel Headshot Pro ni certaines sections de l'éditeur | 🟠 Majeur | Ouvert |
| BUG-009 | Import d'un fichier sans rapport avec un CV génère quand même un CV | 🟡 Mineur | Ouvert |
...
| BUG-011 | Import d'un CV en mandarin — contenu restitué en caractères corrompus | 🔴 Critique | Ouvert |
| BUG-012 | Date de fin antérieure à la date de début acceptée sans validation | 🟠 Majeur | Ouvert |

> **Recommandation go/no-go :** BUG-005 et BUG-011 sont des bloquants critiques. BUG-001, BUG-002, BUG-004, BUG-007, BUG-008 et BUG-010 sont à arbitrer avec l'équipe produit avant déploiement. BUG-003, BUG-006 et BUG-009 peuvent être packagés pour le prochain sprint.
...
**Titre :** Dates impossibles acceptées sans validation (ex : 40/4040)  
**Sévérité :** 🟠 Majeur

| Champ | Détail |
|-------|--------|
| **Étapes de reproduction** | 1. Accéder à l'éditeur de CV sur `app.makemycv.com` <br> 2. Naviguer vers la section « Expériences professionnelles » <br> 3. Ajouter une expérience <br> 4. Dans les champs de dates, saisir des valeurs impossibles (ex : mois 40, année 4040) <br> 5. Confirmer |
| **Résultat attendu** | Un message de validation s'affiche indiquant que la date saisie est invalide. La saisie est bloquée. |
| **Résultat obtenu** | Les dates impossibles sont acceptées sans message d'erreur mais n'apparaissent pas dans le CV. |
| **Environnement** | Chrome 147, Windows 11, 1920×1080 |
| **Capture d'écran** | - |
...
| **Environnement** | Chrome 147, Windows 11, 1920×1080 |
| **Capture d'écran** | <img src="screens/BUG-006.png" width="300"> |
...
| **Résultat attendu** | L'import est refusé avec un message indiquant que le fichier ne contient aucun contenu exploitable. Comportement cohérent avec BUG-006. |
...
| **Environnement** | Chrome 147, Windows 11, 1920×1080 |
| **Capture d'écran** | - |
| **Note** | Comportement incohérent avec BUG-006 : le DOCX vide échoue, le PDF vide réussit. Cette asymétrie suggère deux pipelines de traitement distincts dont l'un ne valide pas le contenu. |

---

## BUG-008

**Titre :** Aucun bouton pour quitter le tunnel Headshot Pro — même problème dans certaines sections de l'éditeur  
**Sévérité :** 🟠 Majeur

| Champ | Détail |
|-------|--------|
| **Étapes de reproduction** | 1. Accéder à l'éditeur de CV sur `app.makemycv.com` <br> 2. Entrer dans la fonctionnalité Headshot Pro <br> 3. Chercher un bouton « Annuler », « Retour » ou « Quitter » <br> 4. Répéter l'observation depuis d'autres sections de l'éditeur |
| **Résultat attendu** | Un bouton de sortie clairement visible permet de revenir à l'éditeur à tout moment. |
| **Résultat obtenu** | Aucun bouton de sortie présent dans Headshot Pro ni dans certaines sections de l'éditeur. L'utilisateur est contraint d'utiliser le bouton Précédent du navigateur ou de modifier manuellement l'URL. |
| **Environnement** | Chrome 147, Windows 11, 1920×1080 |
| **Capture d'écran** | <img src="screens/BUG-008.png" width="500"> |
| **Note** | Combiné à BUG-005 (découverte tardive du paywall Headshot), l'utilisateur se retrouve piégé dans un tunnel payant sans issue visible — double dark pattern. |
...
| **Environnement** | Chrome 147, Windows 11, 1920×1080 |
| **Capture d'écran** | <img src="screens/BUG-009.png" width="300"> <img src="screens/BUG-009.2.png" width="300">|
...
| **Environnement** | Chrome 147, Windows 11, 1920×1080 |
| **Capture d'écran** | <img src="screens/BUG-011.png" width="1000"> |
...
| **Environnement** | Chrome 147, Windows 11, 1920×1080 |
| **Capture d'écran** | <img src="screens/BUG-012.png" width="300"> <img src="screens/BUG-012.2.png" width="500">|
